        ...
        <div id="app"  class="container">
            ...
            <form method="post" action="#">
                <div class="row">
                    ...
                    <button type="submit" class="btn btn-success" onclick="getResults(event)">
                                ...
                                $.ajax({
                                    ...
                                    success: function (data) {
                                        if (data.items != undefined) {
                                            ...
                                            // table.clear().draw();// we need to refresh datatable after getdata success
                                            var table = $("#tblId tbody");
                                            table.empty();
